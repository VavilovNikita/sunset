...
public interface UsersApi {
    ...
    /**
     * PATCH /users/{id}/enrollment-number : Set or clear a staff user&#39;s fingerprint-terminal enrollment number
     * Requires an authenticated session with role &#x60;ADMIN&#x60;. See &#x60;User.enrollmentNumber&#x60;&#39;s own description. &#x60;enrollmentNumber&#x60; must be sent - a number to assign it, or &#x60;null&#x60; to clear it - omitting it entirely is a 400, not a no-op. No self-change restriction, and no &#x60;tokenVersion&#x60; bump - this doesn&#39;t affect authentication. 
     *
     * @param id  (required)
     * @param userEnrollmentNumberUpdateInput  (required)
     * @return Updated user. (status code 200)
     *         or Body failed validation, or &#x60;enrollmentNumber&#x60; was omitted entirely. (status code 400)
     *         or No valid JWT. (status code 401)
     *         or Token is valid but lacks the required role (&#x60;ADMIN&#x60;). (status code 403)
     *         or User not found. (status code 404)
     *         or That enrollment number is already assigned to another employee. (status code 409)
     */
    @RequestMapping(
        method = RequestMethod.PATCH,
        value = "/users/{id}/enrollment-number",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<User> updateUserEnrollmentNumber(
         @PathVariable("id") String id,
         @Valid @RequestBody UserEnrollmentNumberUpdateInput userEnrollmentNumberUpdateInput
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    /**
     * PATCH /users/{id}/full-name : Set or clear a staff user&#39;s full name
     * Requires an authenticated session with role &#x60;ADMIN&#x60;. See &#x60;User.fullName&#x60;&#39;s own description. &#x60;fullName&#x60; must be sent - a string to assign it, or &#x60;null&#x60; to clear it (a blank or whitespace-only string also clears it) - omitting it entirely is a 400, not a no-op. No self-change restriction, and no &#x60;tokenVersion&#x60; bump - this doesn&#39;t affect authentication. 
     *
     * @param id  (required)
     * @param userFullNameUpdateInput  (required)
     * @return Updated user. (status code 200)
     *         or Body failed validation, or &#x60;fullName&#x60; was omitted entirely. (status code 400)
     *         or No valid JWT. (status code 401)
     *         or Token is valid but lacks the required role (&#x60;ADMIN&#x60;). (status code 403)
     *         or User not found. (status code 404)
     */
    @RequestMapping(
        method = RequestMethod.PATCH,
        value = "/users/{id}/full-name",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<User> updateUserFullName(
         @PathVariable("id") String id,
         @Valid @RequestBody UserFullNameUpdateInput userFullNameUpdateInput
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    /**
     * PATCH /users/{id}/overtime-eligibility : Set whether a staff user is eligible for overtime
     * Requires an authenticated session with role &#x60;ADMIN&#x60;. See &#x60;User.overtimeEligible&#x60;&#39;s own description for why this is a per-person flag rather than something derived from a shift code. No self-change restriction, and no &#x60;tokenVersion&#x60; bump - unlike role/active, this can&#39;t lock the caller out of anything and doesn&#39;t affect authentication. Nothing in this API computes or accrues overtime pay from this flag; it only records the fact. 
     *
     * @param id  (required)
     * @param userOvertimeEligibilityUpdateInput  (required)
     * @return Updated user. (status code 200)
     *         or Body failed validation. (status code 400)
     *         or No valid JWT. (status code 401)
     *         or Token is valid but lacks the required role (&#x60;ADMIN&#x60;). (status code 403)
    ...
    @RequestMapping(
        method = RequestMethod.PATCH,
        value = "/users/{id}/overtime-eligibility",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<User> updateUserOvertimeEligibility(
         @PathVariable("id") String id,
         @Valid @RequestBody UserOvertimeEligibilityUpdateInput userOvertimeEligibilityUpdateInput
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
