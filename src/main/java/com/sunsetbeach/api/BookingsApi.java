...
public interface BookingsApi {
     ...
     * Requires CASHIER or above. One endpoint for both directions, same shape as &#x60;PUT /bookings/{id}/room-unit&#x60;: a non-null &#x60;guestId&#x60; links that guest to the booking, &#x60;null&#x60; clears the link. Relinking to a different guest needs no confirmation and no state check - nothing downstream depends on which &#x60;Guest&#x60; a booking points to except that guest&#39;s own stay history (&#x60;GET /guests/{id}&#x60;), so there is nothing to protect the way &#x60;PUT /bookings/{id}/room-unit&#x60; protects inventory. Never touches &#x60;guestName&#x60;/&#x60;guestEmail&#x60;/&#x60;guestPhone&#x60; - those stay frozen exactly as given at booking time regardless of what this endpoint does. 
     *
     * @param id  (required)
