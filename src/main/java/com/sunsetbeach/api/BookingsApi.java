...
public interface BookingsApi {
    ...
    /**
     * PUT /bookings/{id}/guest : Link or unlink the Guest record for a booking
     * Requires CASHIER or above. One endpoint for both directions, same shape as &#x60;PUT /bookings/{id}/room-unit&#x60;: a non-null &#x60;guestId&#x60; links that guest to the booking, &#x60;null&#x60; clears the link. New bookings are already linked automatically by email when one &#x60;Guest&#x60; card matches it unambiguously; this is for corrections. Relinking to a different guest needs no confirmation and no state check - nothing contends for a guest link the way &#x60;PUT /bookings/{id}/room-unit&#x60; contends for inventory. It is not inconsequential, though: which &#x60;Guest&#x60; a booking points to decides both that card&#39;s stay history (&#x60;GET /guests/{id}&#x60;) and whose self-service account lists the booking (&#x60;GET /guest/bookings&#x60;), so linking a booking to the wrong card shows that stay to the wrong guest. Never touches &#x60;guestName&#x60;/&#x60;guestEmail&#x60;/&#x60;guestPhone&#x60; - those stay frozen exactly as given at booking time regardless of what this endpoint does. 
     *
     * @param id  (required)
     * @param bookingGuestLinkInput  (required)
     ...
     *         or Booking or guest not found. (status code 404)
     */
    @RequestMapping(
        method = RequestMethod.PUT,
        value = "/bookings/{id}/guest",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<Booking> assignBookingGuest(
         @PathVariable("id") String id,
         @Valid @RequestBody BookingGuestLinkInput bookingGuestLinkInput
    ) {
