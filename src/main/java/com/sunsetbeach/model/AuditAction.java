...
public enum AuditAction {
  ...
  BOOKING_RELOCATED("BOOKING_RELOCATED"),
  
  BOOKING_RELOCATION_UNDONE("BOOKING_RELOCATION_UNDONE"),
  
  BOOKING_REPRICED("BOOKING_REPRICED"),
  
  BOOKING_CHECKED_IN("BOOKING_CHECKED_IN"),
  
  BOOKING_CHECKED_OUT("BOOKING_CHECKED_OUT"),
  
  BOOKING_NO_SHOW_MARKED("BOOKING_NO_SHOW_MARKED"),
  
  BOOKING_FOLIO_PAYMENT_RECORDED("BOOKING_FOLIO_PAYMENT_RECORDED"),
  ...
  USER_FUNCTIONS_CHANGED("USER_FUNCTIONS_CHANGED"),
  ...
  ROOM_UNIT_HOUSEKEEPING_CHANGED("ROOM_UNIT_HOUSEKEEPING_CHANGED"),
  
  ROOM_UNIT_POSITION_UPDATED("ROOM_UNIT_POSITION_UPDATED"),
  
  PROPERTY_MAP_IMAGE_UPDATED("PROPERTY_MAP_IMAGE_UPDATED"),
  
  PRINT_JOB_DISMISSED("PRINT_JOB_DISMISSED"),
  
  SPA_APPOINTMENT_CREATED("SPA_APPOINTMENT_CREATED"),
  
  SPA_APPOINTMENT_STATUS_CHANGED("SPA_APPOINTMENT_STATUS_CHANGED"),
  
  POS_TABLE_POSITION_UPDATED("POS_TABLE_POSITION_UPDATED"),
  
  MAINTENANCE_TASK_CREATED("MAINTENANCE_TASK_CREATED"),
  
  MAINTENANCE_TASK_STATUS_CHANGED("MAINTENANCE_TASK_STATUS_CHANGED"),
  
  MAINTENANCE_TASK_BLOCKED("MAINTENANCE_TASK_BLOCKED"),
  
  MAINTENANCE_TASK_BLOCK_LIFTED("MAINTENANCE_TASK_BLOCK_LIFTED"),
  ...
  BOOKING_GUEST_LINKED("BOOKING_GUEST_LINKED"),
  
  SPA_MAP_IMAGE_UPDATED("SPA_MAP_IMAGE_UPDATED"),
  
  BOOKING_SEGMENT_ROOM_CHANGED("BOOKING_SEGMENT_ROOM_CHANGED"),
  
  BOOKING_ROOMS_SWAPPED("BOOKING_ROOMS_SWAPPED"),
  
  SPA_APPOINTMENT_RESCHEDULED("SPA_APPOINTMENT_RESCHEDULED"),
  
  SPA_APPOINTMENT_TREATMENT_ADDED("SPA_APPOINTMENT_TREATMENT_ADDED"),
  
  SPA_APPOINTMENT_TREATMENT_REMOVED("SPA_APPOINTMENT_TREATMENT_REMOVED"),
  
  SPA_APPOINTMENT_TABLES_SWAPPED("SPA_APPOINTMENT_TABLES_SWAPPED");
