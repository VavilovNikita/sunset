...
/**
 * Body of &#x60;PATCH /guests/{id}&#x60;. Full replacement of every field below, same convention as &#x60;TableInput&#x60;/&#x60;RoomUnitUpdateInput&#x60; - no partial update.
 */
...
public class GuestUpdateInput {
   ...
   */
  public GuestUpdateInput(String name) {
    this.name = name;
  }
